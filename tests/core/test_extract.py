...
class TestCalcExtractedDataset:
    ...
    def test_no_start_end_date_override(self, log_output, monkeypatch):
        ...
        assert (
            ...
            == f"2022-02-09 15:50: Generated by `reshapr extract {config_yaml.absolute()}`"
        )
    ...
    def test_with_start_end_date_override(self, log_output, monkeypatch):
        def mock_now(tz):
            return arrow.get("2022-06-16 16:02")
        ...
        assert (
            extracted_ds.attrs["history"]
            == f"2022-06-16 16:02: Generated by `reshapr extract {config_yaml.absolute()} "

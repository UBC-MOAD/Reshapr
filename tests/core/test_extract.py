...
class TestCalcExtractedDataset:
    ...
    def test_no_start_end_date_override(self, log_output, monkeypatch):
        def mock_now(tz):
            return arrow.get("2022-02-09 15:50", tzinfo="Canada/Pacific")
        ...
        extracted_ds = extract.calc_extracted_dataset(
            extracted_vars, output_coords, config, config_yaml, start_date, end_date
        )
        ...
        assert (
            ...
            == f"2022-02-09 15:50 -08:00: Generated by `reshapr extract {config_yaml.absolute()}`"
        )
    ...
    def test_with_start_end_date_override(self, log_output, monkeypatch):
        def mock_now(tz):
            return arrow.get("2022-06-16 16:02", tzinfo="Canada/Pacific")
        ...
        assert extracted_ds.name == "test_20220602_20220615"
        assert extracted_ds.attrs["name"] == "test_20220602_20220615"
        assert (
            extracted_ds.attrs["description"]
            == "Day-averaged diatoms biomass extracted from SalishSeaCast v201812 hindcast"
        )
        assert (
            extracted_ds.attrs["history"]
            == f"2022-06-16 16:02 -07:00: Generated by `reshapr extract {config_yaml.absolute()} "
    ...
    def test_with_start_date_override(self, log_output, monkeypatch):
        def mock_now(tz):
            return arrow.get("2022-09-07 11:12", tzinfo="Canada/Pacific")
        ...
        assert extracted_ds.name == "test_20220602_20220616"
        assert extracted_ds.attrs["name"] == "test_20220602_20220616"
        assert (
            extracted_ds.attrs["description"]
            == "Day-averaged diatoms biomass extracted from SalishSeaCast v201812 hindcast"
        )
        assert (
            extracted_ds.attrs["history"]
            == f"2022-09-07 11:12 -07:00: Generated by `reshapr extract {config_yaml.absolute()} "
            f"--start-date 2022-06-02`"
        )
        assert extracted_ds.attrs["Conventions"] == "CF-1.6"
    ...
    def test_with_end_date_override(self, log_output, monkeypatch):
        def mock_now(tz):
            return arrow.get("2022-09-07 11:12", tzinfo="Canada/Pacific")
        ...
        assert extracted_ds.name == "test_20220601_20220615"
        assert extracted_ds.attrs["name"] == "test_20220601_20220615"
        assert (
            extracted_ds.attrs["description"]
            == "Day-averaged diatoms biomass extracted from SalishSeaCast v201812 hindcast"
        )
...
class TestResample:
    ...
    def test_resample(self, log_output, monkeypatch):
